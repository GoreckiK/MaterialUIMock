        ...
        <Paper style={{height: "40%", width: "40%"}}>
                <Table>
                    <TableHead>
                        <TableRow>
                            {headers.map((header, id) => {
                                return (
                                    <TableCell key={id*Math.floor(Math.random()*1000)} ref={drag}>{header}</TableCell>
                                )
                            })}
                        </TableRow>
                        </TableHead>
                    <TableBody>
                        {users.map((user, id) => {
                            return (
                                <TableRow key={id*Math.floor(Math.random()*1000)}>
                                    <TableCell key={id*Math.floor(Math.random()*1000)}>{user.location}</TableCell>
                                    <TableCell key={id*Math.floor(Math.random()*1000)}></TableCell>
                                    <TableCell key={id*Math.floor(Math.random()*1000)}>{user.age}</TableCell>
                                </TableRow>
                            );
                        })}
                    </TableBody>
